...
class Tess::Connections::HipChatJRuby < Tess::Connections::HipChat
  ...
  def message_response_callback(packet, xmpp_room)
    ...
    message = Tess::Message.new(content: content, speaker: speaker, room: room)
  ...
  class Tess::Connections::HipChat::Room
